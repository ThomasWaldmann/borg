...
from ..helpers import Location, format_file_size, format_timedelta, make_path_safe, \
    ...
    StableDict, int_to_bigint, bigint_to_int, parse_timestamp, CompressionSpec, ChunkerParams, mkchunk, \
...
def test_chunk_file_wrapper():
    cfw = ChunkIteratorFileWrapper(iter([mkchunk(b'abc'), mkchunk(b'def')]))
